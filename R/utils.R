...
#'
#' @return The function does not explicitly return a value but generates a Quarto report in the working directory.
#'
#' @import quarto
#' @export
...
generate_word_report <- function(qmd_filename,
  ...
  # Adjust the output filename based on the specified format
